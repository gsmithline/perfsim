...
Optimizes R2 for a given initial infection fraction to match real Astoria
weekly case data. Logs to W&B if WANDB_PROJECT is set.

Environment variables:
  SEED_FRAC       required. Initial infection fraction (e.g. 0.05).
  RUN_TAG         required. Job identifier for outputs and W&B.
  START_WEEK      Astoria data start index. Default 17 (Dec 2020 surge).
  N_WEEKS         Weeks to fit. Default 3 (max 3 = 21 AT steps).
  N_ITERS         R2 optimization iterations. Default 40.
  LR              Adam learning rate for R2. Default 0.5.
  SEED            RNG seed. Default 0.
  OUT_DIR         Output directory. Default runs/calibration/$RUN_TAG.
