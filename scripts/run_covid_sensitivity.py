"""Policy sensitivity check: sweep uniform isolation levels on the COVID ABM.

Runs the ABM once (K_STEPS substeps, fresh state) at each isolation level
to verify the ABM responds to isolation predictions. No LM needed.

Environment variables:
  SEED_FRAC            initial infected fraction. Default 0.05.
  CALIBRATED_R2        transmission rate. If set, overrides AT default.
  K_STEPS              inner substeps. Default 21.
