...
INNATE_MODE="${6:-real}"
TRUST_SCALE="${7:-1.0}"
MIX_LAMBDA="${MIX_LAMBDA:-1.0}"
MOBILITY="${MOBILITY:-memoryless}"
ETA_MOB="${ETA_MOB:-0.5}"
...
export RUN_TAG PLATFORM_TYPES TAU HUNT_LR SEED INNATE_MODE TRUST_SCALE MIX_LAMBDA MOBILITY ETA_MOB \
