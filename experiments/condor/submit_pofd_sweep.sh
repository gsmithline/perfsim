...
case "$WHAT" in
  ...
  # Flow: section3_model_icl_smoke (1 x 3 rounds, Mistral-7B) -> gate
  # with check_section3_model_icl.py --smoke -> section3_model_icl.
  section3_model_icl|section3_model_icl_smoke) TARGETS="$WHAT" ;;
