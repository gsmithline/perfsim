...
_spec = importlib.util.spec_from_file_location("b2", "experiments/competition/02_phase_diagram.py")
...
def main():
    ...
    ax.grid(alpha=0.3)
    fig.tight_layout()
    out = "experiments/competition/figs/phase_pokec.png"
    import os

    os.makedirs("experiments/competition/figs", exist_ok=True)
    fig.savefig(out, dpi=150)
    print("saved", out)
    np.savez("experiments/competition/figs/phase_pokec.npz", mall=mall, sep=sep, div=div)
